...
> [!NOTE]   
> Por exemplo, a URL https://github.com/paulo-pires/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`paulo-pires`" para a contribuição no repositório `dio-lab-open-source`.
